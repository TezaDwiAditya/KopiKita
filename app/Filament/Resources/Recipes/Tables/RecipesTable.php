...
class RecipesTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('menu.name')->label('Menu')->searchable()->sortable(),
                TextColumn::make('name')->label('Nama Resep')->searchable()->placeholder('-'),
                TextColumn::make('items_count')->label('Jumlah Bahan')->numeric()->sortable(),
